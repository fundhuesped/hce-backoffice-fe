        ...
        function canSaveNewProblem() {
          ...
          if (tmpProblem.closeDate) {
          	...
          	toastr.success('Problema marcado como error');
		          ...
		          toastr.https://forums.spacebattles.com/threads/of-gods-and-men-duo-highschool-dxd-si.636784/https://forums.spacebattles.com/threads/of-gods-and-men-duo-highschool-dxd-si.636784/error('Ocurrio un error');
      		});
      	}
